...
export const CUSTOMER_SIDE_QUESTS: Quest[] = [
  ...
  },
  {
    ...
    description: "A couple can't agree on a movie. She wants Romance, he wants Action. Find a compromise — try Comedy, then Thriller, and bring your pick to a customer.",
    giverNpc: "customer",
    type: "social",
    objectives: [
      { id: "visit_romance", description: "Check the Romance section (her pick)", type: "visit_section", target: "ROMANCE", completed: false },
      { id: "visit_action", description: "Check the Action section (his pick)", type: "visit_section", target: "ACTION", completed: false },
      { id: "visit_comedy", description: "Find a compromise in Comedy", type: "visit_section", target: "COMEDY", completed: false },
      { id: "visit_thriller", description: "...or try the Thriller section", type: "visit_section", target: "THRILLER", completed: false },
      { id: "report_back", description: "Talk to the couple with your recommendation", type: "talk_to_npc", target: "customer", completed: false },
    ],
    reward: { xp: 100 },
  },
  {
  ...
  },
  {
    ...
    title: "The Perfect Family Movie Night",
    description: "A parent needs help planning the ultimate family movie night. Check Family, grab a snack, and report back.",
    giverNpc: "customer",
    type: "social",
    objectives: [
      { id: "visit_family", description: "Browse the Family section", type: "visit_section", target: "FAMILY", completed: false },
      { id: "visit_comedy", description: "Also check Comedy for backups", type: "visit_section", target: "COMEDY", completed: false },
      { id: "report_back", description: "Tell the parent what you found", type: "talk_to_npc", target: "customer", completed: false },
    ],
    reward: { xp: 75 },
  },
  {
    id: "critics_challenge",
    title: "The Critic's Challenge",
    description: "A snooty critic says nothing in this store is worth watching. Prove them wrong — browse 4 different genres to build your case.",
    giverNpc: "customer",
    type: "explore",
    objectives: [
      { id: "visit_drama", description: "Browse Drama", type: "visit_section", target: "DRAMA", completed: false },
      { id: "visit_classics", description: "Browse Classics", type: "visit_section", target: "CLASSICS", completed: false },
      { id: "visit_scifi", description: "Browse Sci-Fi", type: "visit_section", target: "SCI-FI", completed: false },
      { id: "visit_thriller", description: "Browse Thriller", type: "visit_section", target: "THRILLER", completed: false },
      { id: "confront_critic", description: "Report back to the critic", type: "talk_to_npc", target: "customer", completed: false },
    ],
    reward: { xp: 125 },
  },
  {
    ...
    description: "A teenager claims nothing scares them. Browse Horror and Thriller to find something that'll keep them up at night.",
    giverNpc: "customer",
    type: "fetch",
    objectives: [
      { id: "visit_horror", description: "Browse Horror for the scariest pick", type: "visit_section", target: "HORROR", completed: false },
      { id: "visit_thriller", description: "Check Thriller for psychological options", type: "visit_section", target: "THRILLER", completed: false },
      { id: "report_back", description: "Bring your recommendation to the teenager", type: "talk_to_npc", target: "customer", completed: false },
    ],
    reward: { xp: 75 },
  },
];
