...
export const STORE_LAYOUT: StoreLayout = {
  ...
  objects: [
    ...
    { id: "shelf-row3-family2", label: "KIDS & FAMILY", category: "shelf", x: 6.06, y: 0, z: 0.68, rotY: -0.175, w: 3.2, d: 0.6, meta: {"genre":"FAMILY","color":"#00006e","backGenre":"DRAMA-P3","backColor":"#00006e"} },
    ...
    { id: "shelf-row4-western2", label: "WESTERN", category: "shelf", x: 3.77, y: 0, z: 2.25, rotY: -0.175, w: 3.2, d: 0.6, meta: {"genre":"WESTERN-P2","color":"#00006e","backGenre":"FANTASY-P2","backColor":"#00006e"} },
