...
export const STORE_LAYOUT: StoreLayout = {
  version: 1,
  objects: [
    // Row 1 — left: ACTION + ADVENTURE (adjacent), right: COMEDY (adjacent)
    ...
    { id: "shelf-row1-action2", label: "ACTION/ADVENTURE", category: "shelf", x: -3.06, y: 0, z: -4.77, rotY: 0.175, w: 3.2, d: 0.6, meta: {"genre":"ADVENTURE","color":"#00006e","backGenre":"THRILLER","backColor":"#00006e"} },
    ...
    { id: "shelf-row1-comedy2", label: "COMEDY", category: "shelf", x: 6.54, y: 0, z: -3.79, rotY: -0.175, w: 3.2, d: 0.6, meta: {"genre":"COMEDY","color":"#00006e","backGenre":"ROMANCE","backColor":"#00006e"} },
    // Row 2 — left: HORROR (adjacent), right: DRAMA (adjacent)
    ...
    { id: "shelf-row2-horror2", label: "HORROR", category: "shelf", x: -2.42, y: 0, z: -2.43, rotY: 0.175, w: 3.2, d: 0.6, meta: {"genre":"HORROR","color":"#00006e","backGenre":"MUSICAL","backColor":"#00006e"} },
    ...
    { id: "shelf-row2-drama2", label: "DRAMA", category: "shelf", x: 6.16, y: 0, z: -1.52, rotY: -0.175, w: 3.2, d: 0.6, meta: {"genre":"DRAMA","color":"#00006e","backGenre":"CLASSICS","backColor":"#00006e"} },
    // Row 3 — left: SCI-FI & FANTASY (adjacent), right: KIDS & FAMILY (adjacent)
    { id: "shelf-row3-scifi", label: "SCI-FI & FANTASY", category: "shelf", x: -5.82, y: 0, z: 1.05, rotY: 0.175, w: 3.2, d: 0.6, meta: {"genre":"SCI-FI","color":"#00006e","backGenre":"ACTION","backColor":"#00006e"} },
    { id: "shelf-row3-scifi2", label: "SCI-FI & FANTASY", category: "shelf", x: -2.12, y: 0, z: 0.07, rotY: 0.175, w: 3.2, d: 0.6, meta: {"genre":"FANTASY","color":"#00006e","backGenre":"ADVENTURE","backColor":"#00006e"} },
    { id: "shelf-row3-family", label: "KIDS & FAMILY", category: "shelf", x: 2.61, y: 0, z: -0.01, rotY: -0.175, w: 3.2, d: 0.6, meta: {"genre":"KIDS","color":"#00006e","backGenre":"COMEDY","backColor":"#00006e"} },
    { id: "shelf-row3-family2", label: "KIDS & FAMILY", category: "shelf", x: 6.06, y: 0, z: 0.68, rotY: -0.175, w: 3.2, d: 0.6, meta: {"genre":"FAMILY","color":"#00006e","backGenre":"DRAMA","backColor":"#00006e"} },
    // Row 4 — left: MUSICALS (adjacent), right: WESTERN (adjacent)
    { id: "shelf-row4-musical", label: "MUSICALS", category: "shelf", x: -12.55, y: 0, z: -1.71, rotY: 0.175, w: 3.2, d: 0.6, meta: {"genre":"MUSICAL","color":"#00006e","backGenre":"HORROR","backColor":"#00006e"} },
    { id: "shelf-row4-musical2", label: "MUSICALS", category: "shelf", x: -5.75, y: 0, z: 3.66, rotY: 0.175, w: 3.2, d: 0.6, meta: {"genre":"MUSICAL","color":"#00006e","backGenre":"SCI-FI","backColor":"#00006e"} },
    { id: "shelf-row4-western", label: "WESTERN", category: "shelf", x: -2, y: 0, z: 2.71, rotY: 0.175, w: 3.2, d: 0.6, meta: {"genre":"WESTERN","color":"#00006e","backGenre":"ROMANCE","backColor":"#00006e"} },
    { id: "shelf-row4-western2", label: "WESTERN", category: "shelf", x: 3.77, y: 0, z: 2.25, rotY: -0.175, w: 3.2, d: 0.6, meta: {"genre":"WESTERN","color":"#00006e","backGenre":"FANTASY","backColor":"#00006e"} },
