...
export const STORE_LAYOUT: StoreLayout = {
  version: 1,
  objects: [
    { id: "shelf-row1-horror", label: "HORROR / CULT", category: "shelf", x: -5.88, y: 0, z: -4.19, rotY: 0.25, w: 3.2, d: 0.6, meta: {"genre":"HORROR","color":"#dc2626","backGenre":"CULT","backColor":"#991b1b"} },
    { id: "shelf-row1-scifi", label: "SCI-FI / FOREIGN", category: "shelf", x: -0.8, y: 0, z: -4.46, rotY: 0.05, w: 3.2, d: 0.6, meta: {"genre":"SCI-FI","color":"#3b82f6","backGenre":"FOREIGN","backColor":"#6366f1"} },
    { id: "shelf-row1-comedy", label: "COMEDY / INDIE", category: "shelf", x: 3.44, y: 0, z: -4.37, rotY: -0.45, w: 3.2, d: 0.6, meta: {"genre":"COMEDY","color":"#f97316","backGenre":"INDIE","backColor":"#a855f7"} },
    { id: "shelf-row2-action", label: "ACTION / THRILLER", category: "shelf", x: -5.73, y: 0, z: -1.55, rotY: 0.35, w: 3.2, d: 0.6, meta: {"genre":"ACTION","color":"#ef4444","backGenre":"THRILLER","backColor":"#7c3aed"} },
    { id: "shelf-row2-classics", label: "CLASSICS / DOCS", category: "shelf", x: 2.94, y: 0, z: -1.28, rotY: -0.45, w: 3.2, d: 0.6, meta: {"genre":"CLASSICS","color":"#ca8a04","backGenre":"DOCS","backColor":"#65a30d"} },
    { id: "shelf-row3-family", label: "FAMILY / ANIMATED", category: "shelf", x: -4.54, y: 0, z: 1.09, rotY: 0.4, w: 3.2, d: 0.6, meta: {"genre":"FAMILY","color":"#22c55e","backGenre":"ANIMATED","backColor":"#06b6d4"} },
    { id: "shelf-row3-western", label: "WESTERN / ROMANCE", category: "shelf", x: 2.26, y: 0, z: 1.48, rotY: -0.4, w: 3.2, d: 0.6, meta: {"genre":"WESTERN","color":"#92400e","backGenre":"ROMANCE","backColor":"#f43f5e"} },
    ...
    { id: "car-van", label: "Van", category: "exterior", x: -4, y: 0, z: 11, rotY: 3.141592653589793, w: 2, d: 1 },
    ...
    { id: "car-sedan2", label: "Sedan 2", category: "exterior", x: -10, y: 0, z: 11, rotY: 3.141592653589793, w: 2, d: 1 },
    { id: "car-police", label: "Police Car", category: "exterior", x: 10, y: 0, z: 11, w: 2, d: 1 },
    { id: "car-delivery", label: "Delivery Van", category: "exterior", x: -2, y: 0, z: 12.5, rotY: 3.141592653589793, w: 2, d: 1 },
    ...
    { id: "stray-cart", label: "Stray Cart", category: "exterior", x: -5, y: 0, z: 13, rotY: 0.4, w: 0.5, d: 0.35 },
